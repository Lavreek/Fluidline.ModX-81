...
Если ваша установка MODX запущена на веб-сервере Apache, вы должны создать файл .htaccess внутри папки ядра <em>[[+fileLocation]]</em>. Это также можно сделать, переименовав существующий уже файл-пример .htaccess в .htaccess.
