...
Якщо установку MODX запущено на веб-сервері Apache, ви повинні створити файл .htaccess всередині папки ядра <em>[[+fileLocation]]</em>. Це також можна зробити, перейменувавши вже наявний файл-приклад .htaccess на .htaccess.
