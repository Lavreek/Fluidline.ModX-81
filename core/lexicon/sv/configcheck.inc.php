...
<strong>Det här är en säkerhetsrisk och rekommenderas inte.</strong> Om din MODX-installation körs på en Apache-server bör du åtminstone aktivera en .htaccess-fil i core-mappen <em>[[+fileLocation]]</em>. Det görs enkelt genom att ändra namnet på exempelfilen .htaccess till .htaccess.
